package com.example.eureka.shared.config;

import com.example.eureka.shared.config.security.JwtAuthenticationEntryPoint;
import com.example.eureka.shared.config.security.JwtRequestFilter;
        ...
        http
                ...
                .authorizeHttpRequests(req -> req
                        .requestMatchers("/v1/auth/login",
                                ...
                                "/v1/eventos/publico",
                                "/v1/blog/publico/articulos",
                                "/v1/blog/articulos/tag/{idTag}",
                                "/v1/blog/publico/articulos/{idArticulo}",
                                "/v1/blog/tags",
                                "/v1/emprendimientos",
